...
1. `swift build`
1. `.build/debug/gymstrategyserver`
...
#### Kubernetes
To deploy your application to your Kubernetes cluster, run `helm install --name myapp .` in the `/chart/gymstrategyserver` directory. You need to make sure you change the `repository` variable in your `chart/gymstrategyserver/values.yaml` file points to the docker image containing your runnable application.
